...
cdef extern from "hip/hiprtc.h":
    ...
    ctypedef hiprtcResult hiprtcResult
    ...
    ctypedef hiprtcJIT_option hiprtcJIT_option
    ...
    ctypedef hiprtcJITInputType hiprtcJITInputType
    ctypedef hiprtcLinkState hiprtcLinkState
    const char * hiprtcGetErrorString(hiprtcResult result) nogil
    hiprtcResult hiprtcVersion(int * major,int * minor) nogil
    ctypedef hiprtcProgram hiprtcProgram
