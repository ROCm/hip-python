...
cdef extern from "hip/hip_runtime_api.h":
    ...
    ctypedef hip_python_aux_struct_2 hipDeviceArch_t
...
cdef extern from "hip/hip_runtime_api.h":
    ...
    ctypedef stream hipStreamCallback_t
...
cdef extern from "hip/hip_ext.h":
    ...
    ctypedef hip_python_aux_struct_21 hipDeviceArch_t
...
cdef extern from "hip/hip_ext.h":
    ...
    #  *
    #  */
    hipError_t hipExtModuleLaunchKernel(hipFunction_t f,uint32_t globalWorkSizeX,uint32_t globalWorkSizeY,uint32_t globalWorkSizeZ,uint32_t localWorkSizeX,uint32_t localWorkSizeY,uint32_t localWorkSizeZ,int sharedMemBytes,hipStream_t hStream,void ** kernelParams,void ** extra,hipEvent_t startEvent,hipEvent_t stopEvent,uint32_t flags) nogil

    # /**
    #  * @brief This HIP API is deprecated, please use hipExtModuleLaunchKernel() instead.
    #  *
    #  */
    hipError_t hipHccModuleLaunchKernel(hipFunction_t f,uint32_t globalWorkSizeX,uint32_t globalWorkSizeY,uint32_t globalWorkSizeZ,uint32_t localWorkSizeX,uint32_t localWorkSizeY,uint32_t localWorkSizeZ,int sharedMemBytes,hipStream_t hStream,void ** kernelParams,void ** extra,hipEvent_t startEvent,hipEvent_t stopEvent) nogil
