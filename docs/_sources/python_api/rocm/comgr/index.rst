...
.. toctree::
   ...
   /python_api/rocm/comgr/amd_hsa_kernel_descriptor/index
   /python_api/rocm/comgr/amdhsa_kernel_directives/index
   /python_api/rocm/comgr/comgr/index
   /python_api/rocm/comgr/hiprtc_header/index
...
.. autoapisummary::
   ...
   rocm.comgr.AMD_COMGR_INTERFACE_VERSION_MAJOR
   rocm.comgr.AMD_COMGR_INTERFACE_VERSION_MINOR
   rocm.comgr.amd_comgr_action_info_t
   rocm.comgr.amd_comgr_action_kind_t
   rocm.comgr.amd_comgr_code_object_info_t
   rocm.comgr.amd_comgr_data_kind_t
   rocm.comgr.amd_comgr_data_set_t
   rocm.comgr.amd_comgr_data_t
   rocm.comgr.amd_comgr_disassembly_info_t
   rocm.comgr.amd_comgr_hotswap_rewrite_flag_t
   rocm.comgr.amd_comgr_hotswap_rewrite_options_t
   rocm.comgr.amd_comgr_language_t
   rocm.comgr.amd_comgr_metadata_kind_t
   rocm.comgr.amd_comgr_metadata_node_t
   rocm.comgr.amd_comgr_status_t
   rocm.comgr.amd_comgr_symbol_info_t
   rocm.comgr.amd_comgr_symbol_t
   rocm.comgr.amd_comgr_symbol_type_t
   rocm.comgr.amd_comgr_symbolizer_info_t
...
.. autoapisummary::
   ...
   rocm.comgr.DataSet
   rocm.comgr.Symbol
   rocm.comgr.amd_comgr_action_info_s
   rocm.comgr.amd_comgr_action_kind_s
   rocm.comgr.amd_comgr_create_disassembly_info_anon_funptr_0
   rocm.comgr.amd_comgr_create_disassembly_info_anon_funptr_1
   rocm.comgr.amd_comgr_create_disassembly_info_anon_funptr_2
   rocm.comgr.amd_comgr_create_symbolizer_info_anon_funptr_0
   rocm.comgr.amd_comgr_data_kind_s
   rocm.comgr.amd_comgr_data_s
   rocm.comgr.amd_comgr_data_set_s
   rocm.comgr.amd_comgr_disassembly_info_s
   rocm.comgr.amd_comgr_hotswap_rewrite_flag_s
   rocm.comgr.amd_comgr_hotswap_rewrite_options_s
   rocm.comgr.amd_comgr_iterate_map_metadata_anon_funptr_0
   rocm.comgr.amd_comgr_iterate_symbols_anon_funptr_0
   rocm.comgr.amd_comgr_language_s
   rocm.comgr.amd_comgr_metadata_kind_s
   rocm.comgr.amd_comgr_metadata_node_s
   rocm.comgr.amd_comgr_status_s
   rocm.comgr.amd_comgr_symbol_info_s
   rocm.comgr.amd_comgr_symbol_s
   rocm.comgr.amd_comgr_symbol_type_s
   rocm.comgr.amd_comgr_symbolizer_info_s
   rocm.comgr.code_object_info_s
...
.. autoapisummary::
   ...
   rocm.comgr.compile_bc
   rocm.comgr.compile_bc_to_hsa
   rocm.comgr.compile_hip_to_bc
   rocm.comgr.compile_hip_to_hsa
   rocm.comgr.compile_hsa
   rocm.comgr.disassemble_amdhsa_code_obj_v6_kernel
   rocm.comgr.disassemble_code_obj_function
   rocm.comgr.disassemble_program
   rocm.comgr.dump_metadata_yaml
   rocm.comgr.get_isa_metadata
   rocm.comgr.get_isa_metadata_all
   rocm.comgr.get_isa_names
   rocm.comgr.parse_code_obj_kernel_names
   rocm.comgr.parse_code_obj_metadata
   rocm.comgr.parse_code_symbols
   rocm.comgr.parse_data_metadata
   rocm.comgr.parse_data_symbols
   rocm.comgr.get_hiprtc_runtime_header
   rocm.comgr.get_hiprtc_runtime_header_origin
   rocm.comgr.amd_comgr_action_data_count
   rocm.comgr.amd_comgr_action_data_get_data
   rocm.comgr.amd_comgr_action_info_get_block_sizes
   rocm.comgr.amd_comgr_action_info_get_block_sizes_count
   rocm.comgr.amd_comgr_action_info_get_bundle_entry_id
   rocm.comgr.amd_comgr_action_info_get_bundle_entry_id_count
   rocm.comgr.amd_comgr_action_info_get_isa_name
   rocm.comgr.amd_comgr_action_info_get_language
   rocm.comgr.amd_comgr_action_info_get_logging
   rocm.comgr.amd_comgr_action_info_get_option_list_count
   rocm.comgr.amd_comgr_action_info_get_option_list_item
   rocm.comgr.amd_comgr_action_info_get_working_directory_path
   rocm.comgr.amd_comgr_action_info_set_block_sizes
   rocm.comgr.amd_comgr_action_info_set_bundle_entry_ids
   rocm.comgr.amd_comgr_action_info_set_device_lib_linking
   rocm.comgr.amd_comgr_action_info_set_isa_name
   rocm.comgr.amd_comgr_action_info_set_language
   rocm.comgr.amd_comgr_action_info_set_logging
   rocm.comgr.amd_comgr_action_info_set_option_list
   rocm.comgr.amd_comgr_action_info_set_vfs
   rocm.comgr.amd_comgr_action_info_set_working_directory_path
   rocm.comgr.amd_comgr_create_action_info
   rocm.comgr.amd_comgr_create_data
   rocm.comgr.amd_comgr_create_data_set
   rocm.comgr.amd_comgr_create_disassembly_info
   rocm.comgr.amd_comgr_create_symbolizer_info
   rocm.comgr.amd_comgr_data_set_add
   rocm.comgr.amd_comgr_data_set_remove
   rocm.comgr.amd_comgr_demangle_symbol_name
   rocm.comgr.amd_comgr_destroy_action_info
   rocm.comgr.amd_comgr_destroy_data_set
   rocm.comgr.amd_comgr_destroy_disassembly_info
   rocm.comgr.amd_comgr_destroy_metadata
   rocm.comgr.amd_comgr_destroy_symbolizer_info
   rocm.comgr.amd_comgr_disassemble_instruction
   rocm.comgr.amd_comgr_do_action
   rocm.comgr.amd_comgr_get_data
   rocm.comgr.amd_comgr_get_data_isa_name
   rocm.comgr.amd_comgr_get_data_kind
   rocm.comgr.amd_comgr_get_data_metadata
   rocm.comgr.amd_comgr_get_data_name
   rocm.comgr.amd_comgr_get_isa_count
   rocm.comgr.amd_comgr_get_isa_metadata
   rocm.comgr.amd_comgr_get_isa_name
   rocm.comgr.amd_comgr_get_mangled_name
   rocm.comgr.amd_comgr_get_metadata_kind
   rocm.comgr.amd_comgr_get_metadata_list_size
   rocm.comgr.amd_comgr_get_metadata_map_size
   rocm.comgr.amd_comgr_get_metadata_string
   rocm.comgr.amd_comgr_get_version
   rocm.comgr.amd_comgr_hotswap_rewrite
   rocm.comgr.amd_comgr_hotswap_rewrite_with_options
   rocm.comgr.amd_comgr_index_list_metadata
   rocm.comgr.amd_comgr_iterate_map_metadata
   rocm.comgr.amd_comgr_iterate_symbols
   rocm.comgr.amd_comgr_lookup_code_object
   rocm.comgr.amd_comgr_map_elf_virtual_address_to_code_object_offset
   rocm.comgr.amd_comgr_map_name_expression_to_symbol_name
   rocm.comgr.amd_comgr_metadata_lookup
   rocm.comgr.amd_comgr_populate_mangled_names
   rocm.comgr.amd_comgr_populate_name_expression_map
   rocm.comgr.amd_comgr_release_data
   rocm.comgr.amd_comgr_set_data
   rocm.comgr.amd_comgr_set_data_from_file_slice
   rocm.comgr.amd_comgr_set_data_name
   rocm.comgr.amd_comgr_status_string
   rocm.comgr.amd_comgr_symbol_get_info
   rocm.comgr.amd_comgr_symbol_lookup
   rocm.comgr.amd_comgr_symbolize
   rocm.comgr.has_symbol
