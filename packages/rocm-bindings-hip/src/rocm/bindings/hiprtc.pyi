...
# Type stubs for rocm.bindings.hiprtc. Edits will be overwritten.
...
class ihiprtcLinkState(rocm.bindings.util.types.Pointer):
...
class _hiprtcProgram(rocm.bindings.util.types.Pointer):
    r"""(No short description)
    """
    def __init__(self, *args, **kwargs): ...
...
def hiprtcCreateProgram(src, name, numHeaders, headers, includeNames):
...
def hiprtcLinkCreate(num_options, option_ptr, option_vals_pptr):
...
def hiprtcLinkComplete(hip_link_state):
    r"""Completes the linking of the given program.
