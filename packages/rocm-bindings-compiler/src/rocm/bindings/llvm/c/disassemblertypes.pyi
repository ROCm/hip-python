...
# Type stubs for rocm.bindings.llvm.c.disassemblertypes. Edits will be overwritten.
...
class LLVMOpInfoCallback(rocm.bindings.util.types.Pointer):
    r"""The type for the operand information call back function.
...
class LLVMOpInfoSymbol1(rocm.bindings.util.types.Pointer):
    r"""The initial support in LLVM MC for the most general form of a relocatable
...
class LLVMOpInfo1(rocm.bindings.util.types.Pointer):
...
class LLVMSymbolLookupCallback(rocm.bindings.util.types.Pointer):
    r"""The type for the symbol lookup function.
