...
# Type stubs for rocm.bindings.amd_comgr. Edits will be overwritten.
...
AMD_COMGR_INTERFACE_VERSION_MAJOR: Any

AMD_COMGR_INTERFACE_VERSION_MINOR: Any

class amd_comgr_status_s(enum.IntEnum):
    r"""Status codes.
    """
    AMD_COMGR_STATUS_SUCCESS: int
    AMD_COMGR_STATUS_ERROR: int
    AMD_COMGR_STATUS_ERROR_INVALID_ARGUMENT: int
    AMD_COMGR_STATUS_ERROR_OUT_OF_RESOURCES: int

amd_comgr_status_t = amd_comgr_status_s

class amd_comgr_language_s(enum.IntEnum):
    r"""The source languages supported by the compiler.
    """
    AMD_COMGR_LANGUAGE_NONE: int
    AMD_COMGR_LANGUAGE_OPENCL_1_2: int
    AMD_COMGR_LANGUAGE_OPENCL_2_0: int
    AMD_COMGR_LANGUAGE_HIP: int
    AMD_COMGR_LANGUAGE_LLVM_IR: int
    AMD_COMGR_LANGUAGE_LAST: int

amd_comgr_language_t = amd_comgr_language_s

def amd_comgr_status_string(status):
...
class amd_comgr_data_kind_s(enum.IntEnum):
    r"""The kinds of data supported.
    """
    AMD_COMGR_DATA_KIND_UNDEF: int
    AMD_COMGR_DATA_KIND_SOURCE: int
    AMD_COMGR_DATA_KIND_INCLUDE: int
    AMD_COMGR_DATA_KIND_PRECOMPILED_HEADER: int
    AMD_COMGR_DATA_KIND_DIAGNOSTIC: int
    AMD_COMGR_DATA_KIND_LOG: int
    AMD_COMGR_DATA_KIND_BC: int
    AMD_COMGR_DATA_KIND_RELOCATABLE: int
    AMD_COMGR_DATA_KIND_EXECUTABLE: int
    AMD_COMGR_DATA_KIND_BYTES: int
    AMD_COMGR_DATA_KIND_FATBIN: int
    AMD_COMGR_DATA_KIND_AR: int
    AMD_COMGR_DATA_KIND_BC_BUNDLE: int
    AMD_COMGR_DATA_KIND_AR_BUNDLE: int
    AMD_COMGR_DATA_KIND_OBJ_BUNDLE: int
    AMD_COMGR_DATA_KIND_SPIRV: int
    AMD_COMGR_DATA_KIND_LAST: int

amd_comgr_data_kind_t = amd_comgr_data_kind_s

class amd_comgr_data_s(rocm.bindings.util.types.Pointer):
    r"""A handle to a data object.
...
class amd_comgr_data_set_s(rocm.bindings.util.types.Pointer):
    r"""A handle to an action data object.
...
class amd_comgr_action_info_s(rocm.bindings.util.types.Pointer):
    r"""A handle to an action information object.
...
class amd_comgr_metadata_node_s(rocm.bindings.util.types.Pointer):
    r"""A handle to a metadata node.
...
class amd_comgr_symbol_s(rocm.bindings.util.types.Pointer):
    r"""A handle to a machine code object symbol.
...
class amd_comgr_disassembly_info_s(rocm.bindings.util.types.Pointer):
    r"""A handle to a disassembly information object.
...
class amd_comgr_symbolizer_info_s(rocm.bindings.util.types.Pointer):
    r"""A handle to a symbolizer information object.
...
def amd_comgr_get_isa_name(index):
...
def amd_comgr_get_isa_metadata(isa_name):
...
def amd_comgr_create_data(kind):
...
def amd_comgr_get_data_kind(data):
...
class amd_comgr_create_symbolizer_info_anon_funptr_0(rocm.bindings.util.types.Pointer):
    r"""(No short description)
    """
    def __init__(self, *args, **kwargs): ...

def amd_comgr_create_symbolizer_info(code_object, print_symbol_callback):
...
def amd_comgr_get_data_metadata(data):
...
def amd_comgr_action_data_count(data_set, data_kind):
...
def amd_comgr_action_data_get_data(data_set, data_kind, index):
...
def amd_comgr_action_info_get_option_list_count(action_info):
...
def amd_comgr_action_info_set_vfs(action_info, should_use_vfs):
...
def amd_comgr_action_info_set_device_lib_linking(action_info, should_link_device_libs):
...
def amd_comgr_action_info_set_block_sizes(action_info, block_sizes, count):
...
def amd_comgr_action_info_get_block_sizes_count(action_info, count):
...
def amd_comgr_action_info_get_block_sizes(action_info, count, block_sizes):
...
class amd_comgr_action_kind_s(enum.IntEnum):
    r"""The kinds of actions that can be performed.
    """
    AMD_COMGR_ACTION_SOURCE_TO_PREPROCESSOR: int
    AMD_COMGR_ACTION_ADD_PRECOMPILED_HEADERS: int
    AMD_COMGR_ACTION_COMPILE_SOURCE_TO_BC: int
    AMD_COMGR_ACTION_LINK_BC_TO_BC: int
    AMD_COMGR_ACTION_CODEGEN_BC_TO_RELOCATABLE: int
    AMD_COMGR_ACTION_CODEGEN_BC_TO_ASSEMBLY: int
    AMD_COMGR_ACTION_LINK_RELOCATABLE_TO_RELOCATABLE: int
    AMD_COMGR_ACTION_LINK_RELOCATABLE_TO_EXECUTABLE: int
    AMD_COMGR_ACTION_ASSEMBLE_SOURCE_TO_RELOCATABLE: int
    AMD_COMGR_ACTION_DISASSEMBLE_RELOCATABLE_TO_SOURCE: int
    AMD_COMGR_ACTION_DISASSEMBLE_EXECUTABLE_TO_SOURCE: int
    AMD_COMGR_ACTION_DISASSEMBLE_BYTES_TO_SOURCE: int
    AMD_COMGR_ACTION_COMPILE_SOURCE_WITH_DEVICE_LIBS_TO_BC: int
    AMD_COMGR_ACTION_COMPILE_SOURCE_TO_RELOCATABLE: int
    AMD_COMGR_ACTION_COMPILE_SOURCE_TO_EXECUTABLE: int
    AMD_COMGR_ACTION_UNBUNDLE: int
    AMD_COMGR_ACTION_COMPILE_SPIRV_TO_RELOCATABLE: int
    AMD_COMGR_ACTION_TRANSLATE_SPIRV_TO_BC: int
    AMD_COMGR_ACTION_COMPILE_SOURCE_TO_SPIRV: int
    AMD_COMGR_ACTION_LAST: int
...
class amd_comgr_metadata_kind_s(enum.IntEnum):
    r"""The kinds of metadata nodes.
    """
    AMD_COMGR_METADATA_KIND_NULL: int
    AMD_COMGR_METADATA_KIND_STRING: int
    AMD_COMGR_METADATA_KIND_MAP: int
    AMD_COMGR_METADATA_KIND_LIST: int
    AMD_COMGR_METADATA_KIND_LAST: int

amd_comgr_metadata_kind_t = amd_comgr_metadata_kind_s

def amd_comgr_get_metadata_kind(metadata):
...
def amd_comgr_get_metadata_map_size(metadata):
...
class amd_comgr_iterate_map_metadata_anon_funptr_0(rocm.bindings.util.types.Pointer):
    r"""(No short description)
    """
    def __init__(self, *args, **kwargs): ...
...
def amd_comgr_metadata_lookup(metadata, key):
...
def amd_comgr_get_metadata_list_size(metadata):
...
def amd_comgr_index_list_metadata(metadata, index):
...
class amd_comgr_iterate_symbols_anon_funptr_0(rocm.bindings.util.types.Pointer):
    r"""(No short description)
    """
    def __init__(self, *args, **kwargs): ...
...
class amd_comgr_symbol_type_s(enum.IntEnum):
    r"""Machine code object symbol type.
    """
    AMD_COMGR_SYMBOL_TYPE_UNKNOWN: int
    AMD_COMGR_SYMBOL_TYPE_NOTYPE: int
    AMD_COMGR_SYMBOL_TYPE_OBJECT: int
    AMD_COMGR_SYMBOL_TYPE_FUNC: int
    AMD_COMGR_SYMBOL_TYPE_SECTION: int
    AMD_COMGR_SYMBOL_TYPE_FILE: int
    AMD_COMGR_SYMBOL_TYPE_COMMON: int
    AMD_COMGR_SYMBOL_TYPE_AMDGPU_HSA_KERNEL: int

amd_comgr_symbol_type_t = amd_comgr_symbol_type_s

class amd_comgr_symbol_info_s(enum.IntEnum):
    r"""Machine code object symbol attributes.
    """
    AMD_COMGR_SYMBOL_INFO_NAME_LENGTH: int
    AMD_COMGR_SYMBOL_INFO_NAME: int
    AMD_COMGR_SYMBOL_INFO_TYPE: int
    AMD_COMGR_SYMBOL_INFO_SIZE: int
    AMD_COMGR_SYMBOL_INFO_IS_UNDEFINED: int
    AMD_COMGR_SYMBOL_INFO_VALUE: int
    AMD_COMGR_SYMBOL_INFO_LAST: int
...
class amd_comgr_create_disassembly_info_anon_funptr_0(rocm.bindings.util.types.Pointer):
    r"""(No short description)
    """
    def __init__(self, *args, **kwargs): ...

class amd_comgr_create_disassembly_info_anon_funptr_1(rocm.bindings.util.types.Pointer):
    r"""(No short description)
    """
    def __init__(self, *args, **kwargs): ...

class amd_comgr_create_disassembly_info_anon_funptr_2(rocm.bindings.util.types.Pointer):
    r"""(No short description)
    """
    def __init__(self, *args, **kwargs): ...

def amd_comgr_create_disassembly_info(isa_name, read_memory_callback, print_instruction_callback, print_address_annotation_callback):
...
class code_object_info_s(rocm.bindings.util.types.Pointer):
    r"""A data structure for Code object information.
    """
    def __init__(self, *args, **kwargs): ...
    isa: Any
    size: Any
...
def amd_comgr_hotswap_rewrite(input, source_isa_name, target_isa_name, output):
...
class amd_comgr_hotswap_rewrite_flag_s(enum.IntEnum):
    r"""HotSwap rewrite option flags.
    """
    AMD_COMGR_HOTSWAP_REWRITE_FLAG_NONE: int
    AMD_COMGR_HOTSWAP_REWRITE_FLAG_ENTRY_TRAMPOLINES: int
    AMD_COMGR_HOTSWAP_REWRITE_FLAG_STRICT_MODE: int

amd_comgr_hotswap_rewrite_flag_t = amd_comgr_hotswap_rewrite_flag_s

class amd_comgr_hotswap_rewrite_options_s(rocm.bindings.util.types.Pointer):
    r"""Options for ``amd_comgr_hotswap_rewrite_with_options.``
    """
    def __init__(self, *args, **kwargs): ...
    size: Any
    flags: Any
...
def amd_comgr_hotswap_rewrite_with_options(input, source_isa_name, target_isa_name, rewrite_options, output):
